    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipality_name', models.CharField(default='गढवा गाउँपालिका', max_length=200)),
                ('municipality_name_english', models.CharField(default='Gadhawa Rural Municipality', max_length=200)),
                ('report_title', models.CharField(default='डिजिटल प्रोफाइल प्रतिवेदन', max_length=300)),
                ('report_title_english', models.CharField(default='Digital Profile Report', max_length=300)),
                ('publication_date', models.DateField(default=django.utils.timezone.now)),
                ('version', models.CharField(default='1.0', max_length=20)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='reports/logo/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_nepali', ckeditor.fields.RichTextField(blank=True, verbose_name='Content (Nepali)')),
                ...
                ('meta_title', models.CharField(blank=True, max_length=200, verbose_name='SEO Title')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='reports.reportcategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('figure_type', models.CharField(choices=[('chart', 'Chart'), ('graph', 'Graph'), ('image', 'Image'), ('diagram', 'Diagram'), ('map', 'Map')], default='chart', max_length=20)),
                ('figure_number', models.CharField(max_length=20, verbose_name='Figure Number')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('description_nepali', models.TextField(blank=True, verbose_name='Description (Nepali)')),
                ('image', models.ImageField(blank=True, null=True, upload_to='reports/figures/')),
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='figures', to='reports.reportsection')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('download_type', models.CharField(choices=[('pdf', 'PDF'), ('full_report', 'Full Report'), ('section', 'Section')], max_length=20)),
                ('ip_address', models.GenericIPAddressField()),
                ('user_agent', models.TextField(blank=True)),
                ('downloaded_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reports.reportsection')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tables', to='reports.reportsection')),
            ],
            options={
