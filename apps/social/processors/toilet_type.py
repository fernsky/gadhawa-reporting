...
class ToiletTypeProcessor(BaseSocialProcessor):
    ...
    def get_data(self):
        ...
        for toilet_choice in ToiletTypeChoice.choices:
            ...
            toilet_households = WardWiseToiletType.objects.filter(
                toilet_type=toilet_code
        ...
        for ward_num in range(1, 8):  # Wards 1-7
            ward_households = WardWiseToiletType.objects.filter(
            ...
            if ward_households > 0:
                ...
                for toilet_choice in ToiletTypeChoice.choices:
                    ...
                    toilet_households_ward = WardWiseToiletType.objects.filter(
                    ...
                    if toilet_households_ward > 0:
                        ward_data[ward_num]['toilet_types'][toilet_code] = {
                            ...
                            'percentage': (toilet_households_ward / ward_households * 100) if ward_households > 0 else 0
                        }
    ...
    def generate_analysis_text(self, data):
        ...
        analysis_parts.append(
            f"लुङ्ग्री गाउँपालिकामा कुल {format_nepali_number(total_households)} घरपरिवारमा विभिन्न प्रकारका शौचालयहरूको प्रयोग भइरहेको छ।"
        )
        
        # Dominant toilet type analysis
        if municipality_data:
            # Find the most used toilet type
            dominant_toilet = max(municipality_data.items(), key=lambda x: x[1]['population'])
            analysis_parts.append(
            ...
            if 'FLUSH_WITH_SEPTIC_TANK' in municipality_data:
                improved_toilets += municipality_data['FLUSH_WITH_SEPTIC_TANK']['population']
        ...
        if ward_data:
            ...
            for ward_num, ward_info in ward_data.items():
                ...
                no_toilet_households = ward_info['toilet_types'].get('NO_TOILET', {}).get('population', 0)
                sanitation_coverage = ((ward_info['total_population'] - no_toilet_households) / ward_info['total_population'] * 100) if ward_info['total_population'] > 0 else 0
            ...
            if best_ward and worst_ward:
                analysis_parts.append(
                    f"वडाको आधारमा हेर्दा, वडा नं. {best_ward} मा सबैभन्दा राम्रो सरसफाइको अवस्था "
        ...
        if 'NO_TOILET' in municipality_data and municipality_data['NO_TOILET']['population'] > 0:
            analysis_parts.append(
