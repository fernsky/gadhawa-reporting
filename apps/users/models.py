...
specific to the Gadhawa Municipality reporting system.
"""
...
class User(AbstractUser):
    """
    Custom User model with additional fields for Gadhawa Report System
    """
    ...
    phone_number = models.CharField(
        ...
        blank=True,
        null=True,
        verbose_name=_('फोन नम्बर')  # Phone Number
    )
    ...
    department = models.CharField(
        ...
        blank=True,
        null=True,
        verbose_name=_('विभाग')  # Department
    )
    ...
    is_verified = models.BooleanField(
        default=False,
        verbose_name=_('प्रमाणित')  # Verified
    )
    ...
    failed_login_attempts = models.IntegerField(
        default=0,
        verbose_name=_('असफल लगइन प्रयासहरू')  # Failed Login Attempts
    )
...
class UserSession(models.Model):
    ...
    session_key = models.CharField(
        max_length=40,
        verbose_name=_('सेसन कुञ्जी')  # Session Key
    )
    
    ip_address = models.GenericIPAddressField(
        verbose_name=_('IP ठेगाना')  # IP Address
    )
    
    user_agent = models.TextField(
        blank=True,
        verbose_name=_('प्रयोगकर्ता एजेन्ट')  # User Agent
    )
    
    login_time = models.DateTimeField(
        auto_now_add=True,
        verbose_name=_('लगइन समय')  # Login Time
    )
    
    logout_time = models.DateTimeField(
        blank=True,
        null=True,
        verbose_name=_('लगआउट समय')  # Logout Time
    )
