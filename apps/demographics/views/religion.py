...
class ReligionDemographicsView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        detailed_analysis = self.generate_detailed_analysis(religion_data, ward_wise_data)
        ...
        context.update({
            ...
            'religious_diversity_index': self.calculate_religious_diversity_index(religion_data),
    ...
    def generate_detailed_analysis(self, religion_data, ward_wise_data):
        ...
        buddhist_data = religion_data.get('BUDDHIST', {'population': 0, 'percentage': 0})
        kirant_data = religion_data.get('KIRANT', {'population': 0, 'percentage': 0})
        christian_data = religion_data.get('CHRISTIAN', {'population': 0, 'percentage': 0})
        ...
        analysis = {
            ...
            'statistical_summary': {
                ...
                'religious_diversity_score': self.calculate_religious_diversity_index(religion_data),
                'minority_religions_count': len([r for r in religion_data.values() if 0 < r['percentage'] < 5.0]),
            }
        }
