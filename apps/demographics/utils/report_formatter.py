...
from apps.reports.utils.nepali_numbers import to_nepali_digits, format_nepali_number, format_nepali_percentage
...
class ReligionReportFormatter:
    ...
    def _generate_demographic_trends(self, religion_data):
        ...
        for religion_type, data in religion_data.items():
            if data['population'] > 0:
                ...
                if data['percentage'] >= 5.0:
                    ...
                    minor_religions.append((name_nepali, data['population'], data['percentage']))
        ...
        if major_religions:
            ...
            analysis += f"""{', '.join(major_names)} धर्मावलम्बीहरूको संख्या उल्लेखनीय रहेको छ । """
