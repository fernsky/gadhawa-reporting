...
from ..models import WardAgeWiseEconomicallyActivePopulation, EconomicallyActiveAgeGroupChoice, GenderChoice
...
class EconomicallyActiveProcessor(BaseDemographicsProcessor):
    ...
    def get_data(self):
        ...
        for age_choice in EconomicallyActiveAgeGroupChoice.choices:
            ...
            age_population = WardAgeWiseEconomicallyActivePopulation.objects.filter(
                age_group=age_code
        ...
        for gender_choice in GenderChoice.choices:
            ...
            gender_population = WardAgeWiseEconomicallyActivePopulation.objects.filter(
                gender=gender_code
            ).aggregate(total=models.Sum('population'))['total'] or 0
            ...
            if gender_population > 0:  # Only include genders with population
                gender_data[gender_code] = {
                    ...
                    'percentage': (gender_population / total_population * 100) if total_population > 0 else 0
                }
        
        # Ward-wise data
        ward_data = {}
        for ward_num in range(1, 8):  # Wards 1-7
            ward_population = WardAgeWiseEconomicallyActivePopulation.objects.filter(
            ...
            if ward_population > 0:
                ...
                for age_choice in EconomicallyActiveAgeGroupChoice.choices:
                    ...
                    age_pop = WardAgeWiseEconomicallyActivePopulation.objects.filter(
                    ...
                    if age_pop > 0:
                        ward_data[ward_num]['age_groups'][age_code] = {
                            'name_nepali': age_name,
                            'population': age_pop,
                            'percentage': (age_pop / ward_population * 100) if ward_population > 0 else 0
                        }
                ...
                for gender_choice in GenderChoice.choices:
                    ...
                    gender_pop = WardAgeWiseEconomicallyActivePopulation.objects.filter(
                    ...
                    if gender_pop > 0:
                        ward_data[ward_num]['genders'][gender_code] = {
                            ...
                            'percentage': (gender_pop / ward_population * 100) if ward_population > 0 else 0
                        }
    ...
    def generate_analysis_text(self, data):
        ...
        if ward_data:
            ...
            highest_ward = max(ward_data.items(), key=lambda x: x[1]['total_population'])
