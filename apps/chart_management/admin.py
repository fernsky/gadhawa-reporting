...
class ChartCacheAdmin(admin.ModelAdmin):
    ...
    search_fields = ["chart_key", "title", "content_hash"]
    ...
    fieldsets = (
        ...
        ("Content Tracking", {"fields": ("content_hash", "svg_content_hash")}),
        ("File Paths", {"fields": ("svg_path", "png_path", "file_status")}),
        (
            "Generation Info",
            {"fields": ("svg_generated_at", "png_generated_at", "error_message")},
        ),
        ("Usage Statistics", {"fields": ("access_count", "last_accessed")}),
        ("Preview", {"fields": ("chart_preview",)}),
    )
    ...
    def file_status(self, obj):
        ...
        return format_html("SVG: {} | PNG: {}", svg_status, png_status)
...
class ChartGenerationLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ["chart_cache__chart_key", "chart_cache__title"]
