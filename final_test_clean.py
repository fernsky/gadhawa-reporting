...
def final_test():
    ...
    # Get data
    categories = ReportCategory.objects.filter(is_active=True).prefetch_related('sections')[:2]
    ...
    print(f"📊 CSS file size: {css_path.stat().st_size} bytes (was ~830 lines, now ~450 lines)")
